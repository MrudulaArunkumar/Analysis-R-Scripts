...
```
```{r}
wordagg <- aggregate(data=Exp1data_OL, RT_ifo~participant+Validity+Distractor1+WordPair, mean)
...
table(Exp1data_OL$Distractor1,Exp1data_OL$CorrectAnswer,Exp1data_OL$Validity,Exp1data_OL$WordPair)
