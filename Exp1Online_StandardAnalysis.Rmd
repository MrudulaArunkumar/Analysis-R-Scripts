...
Understanding the data trends depending on the word
```{r}
...
wordpairplot <- ggplot(meanWordagg, aes(x=Distractor1, color=Validity, y=RTmean))+
  ...
  facet_grid(CorrectAnswer~WordPair)+
  theme_classic()+
  # ylim(550,600)+
...
table(Exp1data_OL$Distractor1,Exp1data_OL$CorrectAnswer,Exp1data_OL$WordPair)
